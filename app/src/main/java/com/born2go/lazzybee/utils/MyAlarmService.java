...
public class MyAlarmService extends Service {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        notification.setLatestEventInfo(this.getApplicationContext(), getString(R.string.app_name), getString(R.string.notificaion_message), pendingNotificationIntent);
